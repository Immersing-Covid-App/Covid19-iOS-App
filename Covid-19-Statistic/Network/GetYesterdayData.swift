...
extension NetworkManager {
    ...
    func getYesterdayDataForCurrentCountry(country: String) {
        ...
        let formaterTodayData = formatter.string(from: currentDate)

        print(formaterTodayData, formatYesterdayDate)

        // проверяем наступила ли новая дата по UTC времени

        if formatYesterdayDate == formaterTodayData {
